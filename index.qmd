...
- un [annuaire du réseau](https://grist.numerique.gouv.fr/o/ssphub/iTFX7gryL8jK/Annuaire) pour s'inscrire et se désinscrire (environ 650 personnes directement inscrites, 350 de par leur fonction) ;
  - l'annuaire comprend notamment un [formulaire](https://grist.numerique.gouv.fr/o/ssphub/forms/jSjAV3L2F8mmiRVuVEpfF7/103) pour s'inscrire automatiquement ;
  - possibilité de voir sa "fiche" (en fait juste la ligne de la table avec son adresse) grâce aux permissions avancées de Grist ;
- des boites à outils :
...
- étoffer la documentationt technique (site et boites à outils)
