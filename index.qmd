...
- faire du site <ssphub.netlify.app> une [**vitrine**]{.blue2} des projets novateurs

- une newsletter

- Pour [__tous les agents__]{.blue2} (chefs ou pas) du SSP
...
# Outils mis en place pour automatiser la gestion du réseau

Principalement deux outils, reposant sur Grist et Tchap :
- un annuaire du réseau pour s'inscrire et se désinscrire (environ 650 personnes directement inscrites, 350 de par leur fonction) ;
- des boites à outils :
